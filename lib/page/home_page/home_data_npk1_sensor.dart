...
class HomeDataNpk1Sensor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      height: SizeDevice.getHeight(context) * 0.33,
                            ...
                            child: Row(
                              ...
                              children: [
                                SensorWidget(
                                  ...
                                  value: '${homeController.npk1Temp.value} °C',
                                ...
                                SensorWidget(
                                  ...
                                  value:
                                      '${homeController.npk1Conduct.value} us/cm',
                                ...
                                SensorWidget(
                                  description: 'pH',
                                  value: '${homeController.npk1Ph.value} pH',
                            ...
                            child: Row(
                              ...
                              children: [
                                SensorWidget(
                                  ...
                                  value:
                                      '${homeController.npk1Nitro.value} mg/kg',
                                ...
                                SensorWidget(
                                  ...
                                  value:
                                      '${homeController.npk1Phos.value} mg/kg',
